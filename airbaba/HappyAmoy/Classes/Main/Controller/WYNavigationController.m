...
+ (void)load {
    ...
    dict[NSFontAttributeName] = [UIFont fontWithName:@"Helvetica-Bold" size:17];
    dict[NSForegroundColorAttributeName] = ColorWithHexString(@"#222222");
    [navBar setTitleTextAttributes:dict];
    [navBar setBarTintColor:QHWhiteColor];
    // 设置导航条背景图片
...
//        UIBarButtonItem *barButtonItem = [[UIBarButtonItem alloc] initWithCustomView:button];
        ...
        viewController.navigationItem.leftBarButtonItem = [[UIBarButtonItem alloc] initWithImage:[UIImage imageOriginalWithNamed:@"icon_back"] style:UIBarButtonItemStylePlain target:self action:@selector(backClick)];
    }
