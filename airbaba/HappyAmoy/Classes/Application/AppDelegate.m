...
//    WYNavigationController *homeVc = [[WYNavigationController alloc] init];
//    WYNavigationController *nav = [[WYNavigationController alloc] initWithRootViewController:homeVc];
     [self.window makeKeyAndVisible];
    //根控制器
    WYNavigationController *homeVc = [[WYNavigationController alloc] init];
    homeVc.navigationBar.hidden = YES;
    self.window.rootViewController = homeVc;
    
    WYTabBarController *mainTabVC = [[WYTabBarController alloc] init];
    [homeVc pushViewController:mainTabVC animated:NO];
...
#ifdef DEBUG
    [JPUSHService setupWithOption:launchOptions appKey:@"db78ca1bf24948bd9c7e9cfa"
                          channel:@"APP Store"
                 apsForProduction:NO
