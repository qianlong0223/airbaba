...
- (void)configUSharePlatforms {
    ...
    //设置友盟社会化组件appkey
//    [[UMSocialManager defaultManager] setUmSocialAppkey:@"5ad20027f29d9845260002fa"];
    [UMConfigure initWithAppkey:@"5ad20027f29d9845260002fa" channel:@"x"];
    
    //打开调试log的开关
    [[UMSocialManager defaultManager] openLog:NO];
    
    //设置微信AppId，设置分享url，默认使用友盟的网址
    [[UMSocialManager defaultManager] setPlaform:UMSocialPlatformType_WechatSession appKey:@"wxf8f65bb217319125" appSecret:@"08368ca311dbfcc0ee4b0eba77405dfe" redirectURL:@"http://www.umeng.com/social"];
    
    [WXApi registerApp:@"wxf8f65bb217319125"];
